...
The PCTR framework is the foundational prompting structure used throughout the AI Learning App. All generated prompts follow this pattern, and all prompt displays make the structure visible (but not intrusive).
...
When displaying prompts in the app, make PCTR structure visible but not intrusive.

**Recommended approach — Subtle labels:**
```
