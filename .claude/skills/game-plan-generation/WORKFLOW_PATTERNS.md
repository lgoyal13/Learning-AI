...
These patterns serve as structural templates for game plan generation. The AI matches the user's task to an appropriate pattern, then customizes based on their specific context.
