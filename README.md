...
- **Prompt Refiner** - Get actionable feedback on how to improve your prompts
- **Workflow Library** - Pre-built workflows for common business tasks
- **Learning Modules** - Understand the fundamentals of working effectively with AI

## Tech Stack

React 19, TypeScript, Vite, Tailwind CSS, Google Gemini API
